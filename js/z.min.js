...
/*1.main*/var _scrollto=null,_last_scroll_xp=null,_last_scroll_dur=null;function scrollto(l,o){clearTimeout(_scrollto),_last_scroll_xp=l,_last_scroll_dur=o,_scrollto=setTimeout(function(){l instanceof jQuery?scrollto3("html,body",_last_scroll_xp,_last_scroll_dur):scrollto2("html,body",_last_scroll_xp,_last_scroll_dur)},125)}function scrollto2(l,o,t){try{var s=$(o);if(0===s.length)return;scrollto3(l,s,t)}catch(l){}}function scrollto3(l,o,t){nul(o)||0===o.length||$(l).animate({scrollTop:o.offset().top-0},null==t?5:t)}function _top(){$("html, body").animate({scrollTop:$(".post-title").offset().top},1e3)}
