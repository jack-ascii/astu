...
/*scroll*/var lastScroll=0,ts={start:$.now(),scroll:$.now()},scrolltimeout=null,scrolldone=!1,scrollwait=1500;function scroll(){var l=$(document).height(),o=$(window).height();if(dbg("scroll()","scrollHeight=",l,"windowHeight=",o),1==compare(l,o)){var r=$(window).scrollTop(),t=o+r;if(dbg("scroll()","windowScroll=",r,"scrollPosition=",t),0!=t){var c=1-(l-t)/l;if(dbg("scroll()","percentDone=",c,"lastScroll=",lastScroll),1==c&&(scrolldone=!0,scrollwait=3e4),0==lastScroll&&(lastScroll=1-(l-o)/l),lastScroll!=c){var s=c-lastScroll;webevent(d.we,d.ue,document.location.pathname+document.location.search+": scroll "+(100*c).trunc(0)+"% ("+(($.now()-ts.start)/1e3/60).trunc(1)+"m); "+(1==compare(s,0)?"+":"-")+(100*s).trunc(0)+"% ("+(($.now()-ts.scroll)/1e3).trunc(0)+"s)"),ts.scroll=$.now()}lastScroll=c}}}var scroll2=function(l){$("html, body").animate({scrollTop:$(l).offset().top})};
...
/*pswipe*/function photoswipe(i){console.log("photoswipe()","options=",i);var t=".gallery",e=!1,a=!1;nul(i)||(empty(i.xp)||(t=i.xp),nul(i.social)||(e=i.social),nul(i.captions)||(a=i.captions)),function(i){var n=[];i(t).find("figure").each(function(){var t=i(this).find("a"),e={src:t.attr("href"),w:t.data("width"),h:t.data("height"),title:t.data("caption")};i(this).attr("index",n.length).attr("id","figure"+n.length),n.push(e)}),i(t+" figure a").click(function(t){t.preventDefault();var r=i(".pswp")[0],l={index:parseInt(i(this).parent("figure").attr("index")),bgOpacity:.85,showHideOpacity:!0,shareEl:e,captionEl:a},o=window._gallery=new PhotoSwipe(r,PhotoSwipeUI_Default,n,l);o.init(),o.listen("close",function(){scroll2("#figure"+_gallery.getCurrentIndex())})});var r=qs("pid");if(r){var l=parseInt(r);if(!Number.isNaN(l)){var o=i("figure img");if(o.length>=l)i(o[l-1]).parent("a").click(),scroll2("#figure"+(l-1))}}}(jQuery)}